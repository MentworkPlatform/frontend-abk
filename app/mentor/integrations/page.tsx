...
import { BarChart3, Target, TrendingUp, BookOpen, Award, Settings, RefreshCw, Plus } from "lucide-react"
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Connect your video conferencing accounts to automatically create and manage online sessions
                      </CardDescription>
                    </CardHeader>
                        ...
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {zoomConnected ? "Connected" : "Connect to create and manage Zoom meetings"}
                            </p>
                          </div>
                        </div>
                        {zoomConnected ? (
                          <Button variant="outline" onClick={() => disconnectService('zoom')}>
                            Disconnect
                          </Button>
                        ) : (
                          <Button 
                      ...
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Connect to create and manage Teams meetings</p>
                          </div>
                        </div>
                      ...
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Connect to create and manage Google Meet sessions</p>
                          </div>
                        </div>
                        <Button variant="outline">
                          <Plus className="mr-2 h-4 w-4" /> Connect
                  ...
                  {zoomConnected && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Configure how Zoom integrates with your mentorship programs
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="auto-schedule" className="font-medium">Auto-schedule meetings</Label>
                            <p className="text-sm text-gray-500">
                              Automatically create Zoom meetings when sessions are scheduled
                            </p>
                          </div>
                          <Switch 
                            id="auto-schedule" 
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="send-reminders" className="font-medium">Send reminders</Label>
                            <p className="text-sm text-gray-500">
                              Send meeting reminders 1 hour before scheduled sessions
                            </p>
                          </div>
                          <Switch 
                            id="send-reminders" 
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="follow-up" className="font-medium">Follow-up emails</Label>
                            <p className="text-sm text-gray-500">
                              Send follow-up emails with recording links after sessions
                            </p>
                          </div>
                          <Switch 
                            id="follow-up" 
                        ...
                        <div className="space-y-2 pt-4">
                          <Label className="font-medium">Default Meeting Settings</Label>
                          <div className="space-y-2 pl-2 pt-1">
                            <div className="flex items-center space-x-2">
                              <Checkbox id="waiting-room" defaultChecked />
                              <Label htmlFor="waiting-room" className="font-normal">Enable waiting room</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                              <Checkbox id="join-before-host" />
                              <Label htmlFor="join-before-host" className="font-normal">Allow participants to join before host</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                              <Checkbox id="recording" defaultChecked />
                              <Label htmlFor="recording" className="font-normal">Automatically record meetings</Label>
                            </div>
                            <div className="flex items-center space-x-2">
                              <Checkbox id="mute-entry" defaultChecked />
                              <Label htmlFor="mute-entry" className="font-normal">Mute participants upon entry</Label>
                            </div>
                          </div>
                        </div>
                      </CardContent>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Connect your calendars to sync availability and automatically schedule sessions
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {googleCalendarConnected ? "Connected" : "Connect to sync your Google Calendar"}
                            </p>
                          </div>
                        </div>
                        {googleCalendarConnected ? (
                          <Button variant="outline" onClick={() => disconnectService('google-calendar')}>
                            Disconnect
                          </Button>
                        ) : (
                          <Button 
                      ...
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">
                              {outlookConnected ? "Connected" : "Connect to sync your Outlook Calendar"}
                            </p>
                          </div>
                        </div>
                        {outlookConnected ? (
                          <Button variant="outline" onClick={() => disconnectService('outlook')}>
                            Disconnect
                          </Button>
                        ) : (
                          <Button 
                      ...
                      <div className="flex items-center justify-between p-4 border rounded-lg">
                        <div className="flex items-center gap-4">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-500">Connect to use Calendly for scheduling</p>
                          </div>
                        </div>
                        <Button variant="outline">
                          <Plus className="mr-2 h-4 w-4" /> Connect
                  ...
                  {(googleCalendarConnected || outlookConnected) && (
                    <Card>
                      <CardHeader>
                        ...
                        <CardDescription>
                          Configure how your calendar integrates with your mentorship programs
                        </CardDescription>
                      </CardHeader>
                      <CardContent className="space-y-4">
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="auto-sync" className="font-medium">Auto-sync availability</Label>
                            <p className="text-sm text-gray-500">
                              Automatically update your availability based on your calendar
                            </p>
                          </div>
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="buffer-time" className="font-medium">Add buffer time</Label>
                            <p className="text-sm text-gray-500">
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="auto-decline" className="font-medium">Auto-decline conflicts</Label>
                            <p className="text-sm text-gray-500">
                        ...
                        <div className="flex items-center justify-between py-2">
                          <div>
                            <Label htmlFor="two-way-sync" className="font-medium">Two-way sync</Label>
                            <p className="text-sm text-gray-500">
                              Sync events from Mentwork to your calendar and vice versa
                            </p>
                          </div>
                ...
                <div className="space-y-6">
                  <Card>
                    <CardHeader>
                      ...
                      <CardDescription>
                        Connect payment processors to receive payments for your programs
                      </CardDescription>
                    </CardHeader>
                    <CardContent className="space-y-6">
                      <div className="flex items-center justify-between p-4 border rounded-lg">
