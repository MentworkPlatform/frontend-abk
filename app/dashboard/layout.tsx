...
import { Calendar, MessageSquare, BookOpen, Users, BarChart3, Settings } from "lucide-react"
      ...
      <div className="flex min-h-screen bg-[#f5f5f5]">
            ...
            <SidebarGroup>
              ...
              <SidebarGroupContent>
                <SidebarMenu>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname === "/dashboard/school-programs"}>
                  ...
                  <SidebarMenuItem>
                    <SidebarMenuButton asChild isActive={pathname === "/programs"}>
                      <Link href="/programs">
                        <BookOpen className="h-4 w-4" />
        ...
        <div className="fixed top-0 left-0 right-0 z-30 bg-white border-b md:hidden">
          <div className="flex items-center justify-between p-4">
            ...
            <MobileNav userType="mentee" userName="John Doe" userRole="Free Plan" links={navLinks} />
          </div>
        </div>
