    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Trainer Portal - Enter your email to reset your password</p>
        </div>

        <Card>
          <CardHeader>
            <CardTitle>Password Recovery</CardTitle>
            <CardDescription>We'll help you regain access to your trainer account</CardDescription>
          </CardHeader>
          ...
          <CardContent>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                ...
                <Link href="/trainer/login" className="font-medium text-[#FFD500] hover:text-[#e6c000]">
                  Sign in
                </Link>
              </p>
            </div>
