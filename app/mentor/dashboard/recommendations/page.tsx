...
const recommendedPrograms = [
  {
    ...
    estimatedMentees: 12,
    description:
      'A comprehensive program teaching entrepreneurs how to secure funding for their startups.',
    matchScore: 98,
  ...
  },
  {
    ...
    estimatedMentees: 15,
    description:
      'Help professionals advance in their careers through strategic planning and skill development.',
    matchScore: 92,
  ...
  },
  {
    ...
    estimatedMentees: 6,
    description:
      'Premium one-on-one coaching for executives looking to enhance their leadership skills.',
    matchScore: 85,
...
const recommendedSessions = [
  {
    ...
    estimatedIncome: 250,
    description:
      'Review and provide feedback on startup pitch decks to improve investor presentations.',
    matchScore: 96,
    frequency: 'Weekly',
  },
  {
    ...
    estimatedIncome: 200,
    description:
      'Help professionals develop personalized career advancement strategies.',
    matchScore: 94,
    frequency: 'Weekly',
  },
  {
    ...
    estimatedIncome: 750,
    description:
      'Interactive workshop helping leaders overcome common challenges through case studies.',
    matchScore: 88,
    frequency: 'Monthly',
  },
]
          ...
          <div className='flex-1 p-8'>
            <div className='mb-8'>
              ...
              <p className='text-gray-500'>
                Based on your goals, here are programs and sessions designed to
              ...
              <Card className='bg-[#F8F7FF] border-[#e0ddff]'>
                <CardContent className='p-6'>
                  <div className='flex justify-between items-start'>
                    ...
                    <Badge className='bg-[#e0ddff] text-[#7B61FF] hover:bg-[#d2cdff]'>
                      Networking
                    </Badge>
                  </div>
                  <h3 className='font-bold text-lg mt-4'>Build your network</h3>
                  <p className='text-sm text-gray-700 mt-1'>
                    Connect with {15 - 8} more mentees to reach your target
                  </p>
                  <div className='mt-2'>
              ...
              <Card className='bg-[#FFF9E6] border-[#ffe7a2]'>
                <CardContent className='p-6'>
                  <div className='flex justify-between items-start'>
                    ...
                    <Badge className='bg-[#FFE7A2] text-[#F8B400] hover:bg-[#FFDF85]'>
                      Impact
                    </Badge>
                  </div>
                  ...
                  <p className='text-sm text-gray-700 mt-1'>
                    Offer more sessions to reach your impact goals
                  </p>
                  <div className='mt-2'>
                    <div className='flex justify-between text-xs mb-1'>
              ...
              <Card className='bg-[#F2FCEF] border-[#d0efca]'>
                <CardContent className='p-6'>
                  <div className='flex justify-between items-start'>
                    ...
                    <Badge className='bg-[#D0EFCA] text-[#4CAF50] hover:bg-[#c1e6ba]'>
                      Revenue
                    </Badge>
                  </div>
                  <h3 className='font-bold text-lg mt-4'>Grow your income</h3>
                  <p className='text-sm text-gray-700 mt-1'>
                    You're 15% toward your annual revenue goal
                  </p>
                  <div className='mt-2'>
                    <div className='flex justify-between text-xs mb-1'>
                      <span>$3,800</span>
                    ...
                    <Card key={program.id} className='overflow-hidden'>
                        ...
                        <div className='grid grid-cols-2 gap-4 mt-4'>
                          <div className='border rounded-md p-3 bg-gray-50'>
                            ...
                            <p className='text-lg font-bold'>
                              ${program.estimatedIncome.toLocaleString()}
                            </p>
                          </div>
                          <div className='border rounded-md p-3 bg-gray-50'>
                            <p className='text-xs text-gray-500'>
                      ...
                      <CardFooter className='pt-2'>
                        <Button
                          ...
                          onClick={() =>
                            router.push('/mentor/dashboard/programs/create')
                          }
                        >
                    ...
                    <Card key={session.id} className='overflow-hidden'>
                      ...
                      <CardContent className='pb-2'>
                        ...
                        <div className='grid grid-cols-2 gap-4 mt-4'>
                          <div className='border rounded-md p-3 bg-gray-50'>
                            ...
                            <p className='text-lg font-bold'>
                              ${session.estimatedIncome.toLocaleString()}
                            </p>
                          </div>
                          <div className='border rounded-md p-3 bg-gray-50'>
                      ...
                      <CardFooter className='pt-2'>
                        <Button
                          ...
                          onClick={() =>
                            router.push('/mentor/dashboard/sessions/create')
                          }
                        >
                          <Plus className='mr-2 h-4 w-4' />
                          Create Session
            ...
            <div className='mb-4'>
              ...
              <p className='text-gray-500'>
                Connect these tools to enhance your mentorship experience
              </p>
            </div>
              ...
              <div className='flex items-start gap-4'>
                ...
                <div>
                  ...
                  <p className='text-gray-600 mb-4'>
                    Get verified status, reduced commissions, and premium
                    features to boost your mentorship success.
                  </p>
                  <Button
