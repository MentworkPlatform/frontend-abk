...
const sampleProgram = {
  ...
  tagline:
    'Learn how to secure funding for your startup with proven strategies',
  description:
  ...
  sessions: [
    {
      ...
      description:
        'Overview of funding options and understanding investor expectations',
      isFree: true,
      duration: '90',
      date: '2025-06-15',
      time: '10:00',
    ...
    },
    {
      ...
      description:
        'Learn how to structure your pitch deck to attract investors',
      isFree: false,
      duration: '90',
      date: '2025-06-22',
      time: '10:00',
    ...
    },
    {
      ...
      description:
        'How to create realistic financial projections that investors trust',
      isFree: false,
      duration: '90',
      date: '2025-06-29',
      time: '10:00',
  ...
  bonuses: [
    ...
    },
    {
      ...
      description:
        'Customizable Excel/Google Sheets template for creating financial projections',
    },
  ],
  coverImage: null,
}
...
export default function EditProgramPage() {
  ...
  const updateSessionContentItem = (
    sessionIndex: number,
    itemIndex: number,
    value: string
  ) => {
  ...
  const removeSessionContentItem = (
    sessionIndex: number,
    itemIndex: number
  ) => {
    const updatedSessions = [...programData.sessions]
      ...
      <div className='container max-w-4xl'>
        <div className='mb-8'>
          <div className='flex justify-between items-center mb-6'>
            <div>
              <Link
                href={`/mentor/dashboard/programs/${programId}`}
              ...
              <div className='flex items-center gap-3'>
                ...
                <Badge variant='outline'>
                  {programData.isPublic ? 'Published' : 'Draft'}
                </Badge>
              </div>
            </div>
            ...
            <div className='flex items-start gap-3'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-600'>
                  Changes you make will be immediately visible to users.
                  Consider creating a duplicate if you want to make major
                  changes.
                </p>
              </div>
            </div>
          ...
          <TabsContent value='basic'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Edit the essential details about your mentorship program
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-6'>
                ...
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-gray-500'>
                    This will appear under your title and in search results
                  </p>
                </div>
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setProgramData({ ...programData, industry: value })
                      }
                      required
                    >
                ...
                <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                  ...
                  <div className='space-y-3'>
                    ...
                    <Select
                      ...
                      onValueChange={(value) =>
                        setProgramData({ ...programData, language: value })
                      }
                      required
                    >
                    ...
                    {programData.coverImage ? (
                      <div className='space-y-3'>
                        ...
                        <Button
                          ...
                          variant='outline'
                          onClick={() =>
                            setProgramData({ ...programData, coverImage: null })
                          }
                        >
                          Change Image
                        </Button>
          ...
          <TabsContent value='content'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Define what participants will learn and the structure of your
                  program
                </CardDescription>
              </CardHeader>
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Add 3-5 key learning outcomes that will appear on
                            your program page
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <Card key={session.id}>
                        ...
                        <CardContent className='space-y-4'>
                          <div className='grid grid-cols-1 md:grid-cols-2 gap-4'>
                            ...
                            <div className='space-y-2'>
                              <Label htmlFor={`session-${index}-free`}>
                                Session Type
                              </Label>
                          ...
                          <div className='space-y-2'>
                            <Label htmlFor={`session-${index}-description`}>
                              Session Description*
                            </Label>
                            <Textarea
                          ...
                          <div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
                            <div className='space-y-2'>
                              <Label htmlFor={`session-${index}-duration`}>
                                Duration (minutes)*
                              </Label>
                              <Input
                            ...
                            <div className='space-y-2'>
                              <Label htmlFor={`session-${index}-date`}>
                                Date
                              </Label>
                              <Input
                            ...
                            <div className='space-y-2'>
                              <Label htmlFor={`session-${index}-time`}>
                                Time
                              </Label>
                              <Input
                              ...
                              {session.contentItems.map((item, itemIndex) => (
                                <div key={itemIndex} className='flex gap-2'>
                                  ...
                                  <Button
                                    ...
                                    size='icon'
                                    onClick={() =>
                                      removeSessionContentItem(index, itemIndex)
                                    }
                  ...
                  <div className='flex justify-between items-center'>
                    ...
                    <TooltipProvider>
                      <Tooltip>
                        ...
                        <TooltipContent>
                          <p>
                            Add valuable resources that will be included in your
                            program
                          </p>
                        </TooltipContent>
                      </Tooltip>
                      ...
                      <div className='space-y-3'>
                        <div className='space-y-2'>
                          ...
                          <Input
                            ...
                            value={bonus.title}
                            onChange={(e) =>
                              updateBonus(index, { title: e.target.value })
                            }
                        ...
                        <div className='space-y-2'>
                          <Label htmlFor={`bonus-${index}-description`}>
                            Description*
                          </Label>
                          <Input
          ...
          <TabsContent value='pricing'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Set the price for your program and manage enrollment options
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-6'>
                <div className='space-y-3'>
                  ...
                  <p className='text-sm text-gray-500'>
                    Recommended price: $800-$1500 for group programs,
                    $1500-$3000 for 1:1 programs
                  </p>
                </div>
                ...
                <div className='py-4 px-6 bg-[#f8f8f8] rounded-lg border border-gray-200'>
                  ...
                  <p className='text-sm text-gray-600 mb-4'>
                    As a mentor, you'll receive a percentage of the program
                    price based on your activity level:
                  </p>
                ...
                <div className='space-y-3'>
                  <div className='flex items-center justify-between py-2'>
                    <div>
                      ...
                      <p className='text-sm text-gray-500'>
                        Maximum number of participants (Group programs only)
                      </p>
                    </div>
          ...
          <TabsContent value='settings'>
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Configure additional settings for your program
                </CardDescription>
              </CardHeader>
              <CardContent className='space-y-6'>
                <div className='flex justify-between items-center py-3 border-b'>
                  <div>
                    ...
                    <p className='text-sm text-gray-500'>
                      Automatically approve mentee applications without review
                    </p>
                  </div>
                  <Switch
                    id='auto-approve'
                ...
                <div className='flex justify-between items-center py-3 border-b'>
                  <div>
                    <Label
                      htmlFor='public-program'
                      className='block font-medium'
                    >
                      Public program
                    </Label>
                    <p className='text-sm text-gray-500'>
                      Make this program visible in search results and program
                      listings
                    </p>
                  </div>
                  <Switch
                    ...
                    onCheckedChange={(checked) =>
                      setProgramData({ ...programData, isPublic: checked })
                    }
                  />
                </div>
                ...
                <div className='flex justify-between items-center py-3 border-b'>
                  <div>
                    ...
                    <p className='text-sm text-gray-500'>
                      Provide a certificate of completion to participants
                    </p>
                  </div>
                  <Switch
                    id='certificate'
