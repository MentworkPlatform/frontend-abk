...
import { Eye, EyeOff, Mail, Lock, ArrowRight, Users, BookOpen, Award } from "lucide-react"
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">Choose your portal and sign in to continue</p>
        </div>
          ...
          <CardHeader>
            ...
            <div className="flex items-center space-x-2 pt-2">
              ...
              <div>
                ...
                <CardDescription className="text-sm">{userTypeInfo.description}</CardDescription>
              </div>
            </div>
          </CardHeader>
          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                ...
                <Link href="/forgot-password" className="text-sm text-[#FFD500] hover:text-[#e6c000]">
                  Forgot password?
                </Link>
              </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-gray-600">
                New to Mentwork?{" "}
                <Link href="/get-started" className="font-medium text-[#FFD500] hover:text-[#e6c000]">
                  Get started
                </Link>
              </p>
            </div>
          ...
          <Card className="bg-gradient-to-r from-[#FFD500]/10 to-[#FFD500]/5">
            <CardContent className="p-4">
              <h3 className="font-medium text-sm mb-2">
                {activeTab.charAt(0).toUpperCase() + activeTab.slice(1)} Benefits
              </h3>
